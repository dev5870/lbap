    ...
    <div class="simplebar-content-wrapper">
        <div class="simplebar-content">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.page.*') ? 'active' : '' }}">
                    <a depth="0" activeclassname="active" class="sidebar-link"
                       href="{{ Route('admin.page.index') }}">
                        ...
                        <span class="align-middle" depth="0">{{ __('title.menu.page') }}</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.statistic.*') ? 'active' : '' }}">
                    ...
                    <ul id="statistic" class="sidebar-dropdown list-unstyled collapse">
                        ...
                        <li class="sidebar-item">
                            <a depth="1" activeclassname="active"
                               class="sidebar-link {{ request()->routeIs('admin.statistic.finance') ? 'active' : '' }}"
                               href="{{ Route('admin.statistic.finance') }}">
                                <span class="align-middle" depth="1">{{ __('title.statistic.finance') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
