@extends('layouts.default', ['title' => __('title.page.add')])
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="mb-0 card-title h5" tag="h5">{{ __('title.page.add') }}</div>
                </div>
                <div class="card-body">
                    <form class="" method="POST" action="{{ Route('admin.page.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text" placeholder="{{ __('title.content.text') }}"
                                                      class="form-control" rows="5" required>{{ old('text') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
